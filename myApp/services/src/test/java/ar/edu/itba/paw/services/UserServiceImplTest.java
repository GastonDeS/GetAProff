...
//        //Setup
//        Mockito.when(mockDao.create(eq(USERNAME), eq(USER_MAIL), eq(USER_PASS), eq(USER_ROLE)))
//                .thenReturn(new User(USERNAME, USER_MAIL, USER_ID, USER_PASS, USER_ROLE));
//
//        //Test
//        final Optional<User> maybeUser = userService.create(USERNAME, USER_MAIL, USER_PASS, USER_ROLE);
//
//        //Postconditions
