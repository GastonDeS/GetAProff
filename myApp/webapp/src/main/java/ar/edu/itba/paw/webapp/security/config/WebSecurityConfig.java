        ...
        http
                ...
                .and()
                    .antMatcher(API_PREFIX+"/**").authorizeRequests()
                        ...
                        .antMatchers(HttpMethod.POST, API_PREFIX+"/subject-files/{id}/{subject}/{level}").access("@antMatcherVoter.canAccessSubjectFile(authentication, #id)")
                        ...
                        .antMatchers(HttpMethod.POST,API_PREFIX+"/users/{id}/teacher").access("@antMatcherVoter.canAccessWithSameId(authentication, #id)")
                        .antMatchers(HttpMethod.POST,API_PREFIX+"/users/{id}/student").access("@antMatcherVoter.canAccessWithSameId(authentication, #id)")
